...
namespace Learning_C_Sharp_Console_Application
{
    internal class Exercises
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\nA derived class is a class that is created from another");
            Console.WriteLine("class.  The derived class inherits the methods and properties");
            Console.WriteLine("of the parent class, but can also have methods and properties");
            Console.WriteLine("unique to the derived class.  In the previous example, the");
            Console.WriteLine("server is a derived class of employee.");
